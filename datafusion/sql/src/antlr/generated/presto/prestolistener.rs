...
pub trait PrestoListener<'input>:
    ParseTreeListener<'input, PrestoParserContextType>
{
    /**
     ...
     * @param ctx the parse tree
     */
    fn enter_standalonePathSpecification(
        &mut self,
        _ctx: &StandalonePathSpecificationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_standalonePathSpecification(
        &mut self,
        _ctx: &StandalonePathSpecificationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_setSchemaAuthorization(
        &mut self,
        _ctx: &SetSchemaAuthorizationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_setSchemaAuthorization(
        &mut self,
        _ctx: &SetSchemaAuthorizationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_setTableAuthorization(
        &mut self,
        _ctx: &SetTableAuthorizationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn enter_createMaterializedView(
        &mut self,
        _ctx: &CreateMaterializedViewContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_createMaterializedView(
        &mut self,
        _ctx: &CreateMaterializedViewContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_refreshMaterializedView(
        &mut self,
        _ctx: &RefreshMaterializedViewContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_refreshMaterializedView(
        &mut self,
        _ctx: &RefreshMaterializedViewContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_renameMaterializedView(
        &mut self,
        _ctx: &RenameMaterializedViewContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_renameMaterializedView(
        &mut self,
        _ctx: &RenameMaterializedViewContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_setMaterializedViewProperties(
        &mut self,
        _ctx: &SetMaterializedViewPropertiesContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_setMaterializedViewProperties(
        &mut self,
        _ctx: &SetMaterializedViewPropertiesContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_showCreateMaterializedView(
        &mut self,
        _ctx: &ShowCreateMaterializedViewContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_showCreateMaterializedView(
        &mut self,
        _ctx: &ShowCreateMaterializedViewContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_nonDefaultPropertyValue(
        &mut self,
        _ctx: &NonDefaultPropertyValueContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_nonDefaultPropertyValue(
        &mut self,
        _ctx: &NonDefaultPropertyValueContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_listAggOverflowBehavior(
        &mut self,
        _ctx: &ListAggOverflowBehaviorContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_listAggOverflowBehavior(
        &mut self,
        _ctx: &ListAggOverflowBehaviorContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_listaggCountIndication(
        &mut self,
        _ctx: &ListaggCountIndicationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_listaggCountIndication(
        &mut self,
        _ctx: &ListaggCountIndicationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_tableFunctionInvocation(
        &mut self,
        _ctx: &TableFunctionInvocationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_tableFunctionInvocation(
        &mut self,
        _ctx: &TableFunctionInvocationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_parenthesizedRelation(
        &mut self,
        _ctx: &ParenthesizedRelationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn enter_tableFunctionArgument(
        &mut self,
        _ctx: &TableFunctionArgumentContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn enter_valueExpressionDefault(
        &mut self,
        _ctx: &ValueExpressionDefaultContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_valueExpressionDefault(
        &mut self,
        _ctx: &ValueExpressionDefaultContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_specialDateTimeFunction(
        &mut self,
        _ctx: &SpecialDateTimeFunctionContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_specialDateTimeFunction(
        &mut self,
        _ctx: &SpecialDateTimeFunctionContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_parenthesizedExpression(
        &mut self,
        _ctx: &ParenthesizedExpressionContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_parenthesizedExpression(
        &mut self,
        _ctx: &ParenthesizedExpressionContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_jsonExistsErrorBehavior(
        &mut self,
        _ctx: &JsonExistsErrorBehaviorContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_jsonExistsErrorBehavior(
        &mut self,
        _ctx: &JsonExistsErrorBehaviorContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_jsonQueryWrapperBehavior(
        &mut self,
        _ctx: &JsonQueryWrapperBehaviorContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_jsonQueryWrapperBehavior(
        &mut self,
        _ctx: &JsonQueryWrapperBehaviorContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_transactionAccessMode(
        &mut self,
        _ctx: &TransactionAccessModeContext<'input>,
    ) {
    }
    /**
